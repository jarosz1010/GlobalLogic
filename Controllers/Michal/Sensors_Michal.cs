...
{
    public class Sensors_Michal : Controller
    {
        private readonly GL_Sensors_v0_2Context _context;

        public Sensors_Michal(GL_Sensors_v0_2Context context)
        {
            _context = context;
        }
        ...
        // GET: Sensors_Michal/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Sensors_Michal/Create
