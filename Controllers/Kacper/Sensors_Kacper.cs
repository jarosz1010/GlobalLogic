...
{
    public class Sensors_Kacper : Controller
    {
        private readonly GL_Sensors_v0_2Context _context;

        public Sensors_Kacper(GL_Sensors_v0_2Context context)
        {
            _context = context;
        }
        ...
        // GET: Sensors_Kacper/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Sensors_Kacper/Create
