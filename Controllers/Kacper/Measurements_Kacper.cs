...
namespace GL_Sensors_v0._2.Controllers.Kacper
{
    public class Measurements_Kacper : Controller
    {
        private readonly GL_Sensors_v0_2Context _context;

        public Measurements_Kacper(GL_Sensors_v0_2Context context)
        {
            _context = context;
        }

        // GET: Measurements_Kacper
        ...
        // GET: Measurements_Kacper/Details/5
        ...
        // GET: Measurements_Kacper/Create
        ...
        // POST: Measurements_Kacper/Create
        ...
        // GET: Measurements_Kacper/Edit/5
        ...
        // POST: Measurements_Kacper/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Measurements_Kacper/Delete/5
        ...
        // POST: Measurements_Kacper/Delete/5
