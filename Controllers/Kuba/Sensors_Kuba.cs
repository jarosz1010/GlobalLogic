...
{
    public class Sensors_Kuba : Controller
    {
        private readonly GL_Sensors_v0_2Context _context;

        public Sensors_Kuba(GL_Sensors_v0_2Context context)
        {
            _context = context;
        }
        ...
        // GET: Sensors_Kuba/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Sensors_Kuba/Create
