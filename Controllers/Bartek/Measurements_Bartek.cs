...
namespace GL_Sensors_v0._2.Controllers.Bartek
{
    public class Measurements_Bartek : Controller
    {
        private readonly GL_Sensors_v0_2Context _context;

        public Measurements_Bartek(GL_Sensors_v0_2Context context)
        {
            _context = context;
        }

        // GET: Measurements_Kuba
        ...
        // GET: Measurements_Kuba/Details/5
        ...
        // GET: Measurements_Kuba/Delete/5
        ...
        // POST: Measurements_Kuba/Delete/5
